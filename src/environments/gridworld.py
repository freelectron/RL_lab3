...
class GridworldEnv(discrete.DiscreteEnv):
    ...
    def _set_random_goal_state(self):
        ...
        state_int_x = random.choice([i for i in range(0, self.shape[0])])
        state_int_y = random.choice([i for i in range(0, self.shape[1])])
    ...
    def perform_reset(self):
        ...
        return self.make_coordinates(s), self.goal_state_coordinates
