...
from experience_replay.segment_tree import SumSegmentTree, MinSegmentTree
...
class PrioritizedHindsightReplayBuffer(HindsightReplayBuffer):
    def __init__(self, size, alpha, beta):
        """Create Prioritized Replay buffer.
        ...
        ReplayBuffer.__init__
        """
        super(PrioritizedHindsightReplayBuffer, self).__init__(size)
        assert alpha >= 0
        self._alpha = alpha
        assert beta > 0
        self._beta = beta
