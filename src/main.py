...
if __name__ == '__main__':
    ...
    plot_results(er_results, per_results, her_results, pher_results, parameters, fig_name='acrobot_ER')

    parameters['buffer'] = PrioritizedReplayBuffer
    parameters['alpha'] = 0.6
    parameters['beta'] = 0.4
    per_results = [main(parameters) for _ in range(n)]
    plot_results(er_results, per_results, her_results, pher_results, parameters, fig_name='acrobot_PER')

    parameters['buffer'] = HindsightReplayBuffer
    her_results = [main(parameters) for _ in range(n)]
    plot_results(er_results, per_results, her_results, pher_results, parameters, fig_name='acrobot_HER')

    parameters['buffer'] = PrioritizedHindsightReplayBuffer
    pher_results = [main(parameters) for _ in range(n)]
    plot_results(er_results, per_results, her_results, pher_results, parameters, fig_name='acrobot_PHER')
